...
public class Api
{
    ...
    public static void getIncidenceDetailSdk(final IRequestListener viewListener, User user, Vehicle vehicle)
    {
        //Networking.setBasicHeader(HEADER_TOKEN, getToken());

        String url = Constants.BASE_URL + "/sdk/incidence/detail";
        log("Request: " + url);
    ...
    public static void trackingIncidence(final IRequestListener viewListener, String incidenceId) {
        String url = Constants.BASE_URL + "/" + "incidence/tracking" + "/" + incidenceId;
        log("Request: " + url);
